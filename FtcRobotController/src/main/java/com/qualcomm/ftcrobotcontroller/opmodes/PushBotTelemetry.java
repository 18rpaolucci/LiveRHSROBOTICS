 ...
 *     12 - The power being sent to the right arm's motor controller.
 */
...

{
...

    {
        ...
        telemetry.addData
            ( "04"
            , "Right Arm: " + a_right_arm_power ()
            );
        telemetry.addData
            ( "05"
            , "Left Hand Position: " + a_hand_position ()
            );
        telemetry.addData
            ( "06"
            , "Right Hand Position: " + b_hand_position ()
            );
...

    {
        ...
        telemetry.addData ("10", "GP2 Right: " + -gamepad2.right_stick_y);
