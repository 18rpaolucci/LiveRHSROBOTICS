...

{
    ...
    double a_right_arm_power ()
    {
        ...
        {
            r_return = v_motor_right_arm.getPower ();
        }
     ...
     */
    void l_hand_position (double p_position)
    {
        //
    ...
    void r_hand_position (double p_position)
    {
        //
        // Ensure the specific value is legal.
        //
    ...
    private DcMotor v_motor_legacy1;
    private DcMotor v_motor_legacy2;
    ...
    if(v_motor_right_drive.getPower() == 0.0 && v_motor_left_drive.getPower() == 0.0)
    return true;
    else
        return false;
}
